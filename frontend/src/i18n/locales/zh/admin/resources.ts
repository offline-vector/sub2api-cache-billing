export default {
    ...
    usage: {
      ...
      cacheBillingComparison: '客户与上游口径',
      upstreamInputTotal: '上游输入总量',
      upstreamCacheRead: '上游缓存读取',
      customerCacheRead: '客户缓存读取',
      reclassifiedInput: '转为普通输入',
      appliedCacheRatio: '生效比例',
      customerStandardCost: '客户标准费用',
      upstreamMeteredCost: '上游标准费用',
      billingPolicyDelta: '计费策略差额',
