export default {
  ...
  usage: {
    ...
    upstreamInput: 'Upstream input',
    upstreamCacheRead: 'Upstream cache',
    upstreamStandardCost: 'Upstream standard',
    customerCacheRead: 'Customer cache read',
    customerCacheHitRate: 'Customer cache hit rate',
    upstreamCacheHitRate: 'Upstream cache hit rate',
