export default {
    ...
    usage: {
      ...
      cacheBillingComparison: 'Customer vs upstream',
      upstreamInputTotal: 'Upstream prompt total',
      upstreamCacheRead: 'Upstream cache read',
      customerCacheRead: 'Customer cache read',
      reclassifiedInput: 'Reclassified as input',
      appliedCacheRatio: 'Applied ratio',
      customerStandardCost: 'Customer standard cost',
      upstreamMeteredCost: 'Upstream metered cost',
      billingPolicyDelta: 'Billing policy delta',
