...
const GITHUB_REPO = 'offline-vector/sub2api-cache-billing'
// Fork image published by CI (tags carry no "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/offline-vector/sub2api'
