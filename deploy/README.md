...
| `UPDATE_GITHUB_TOKEN` | No | *(empty)* | Token for GitHub release checks and private release assets; sent only to the exact `api.github.com` authority and stripped before CDN redirects. |
