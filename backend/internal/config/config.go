...
type GatewayConfig struct {
	...
	// SharedProbeTurnStateEnabled permits verified synthetic bootstrap state only.
	// Real client conversation state is never published to this account/model pool.
	SharedProbeTurnStateEnabled bool `mapstructure:"shared_probe_turn_state_enabled"`
...
func setDefaults() {
	...
	viper.SetDefault("gateway.shared_probe_turn_state_enabled", false)
