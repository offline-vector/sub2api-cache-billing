...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "turn_state_audit", Type: field.TypeJSON, Nullable: true},
		...
		{Name: "upstream_input_tokens", Type: field.TypeInt, Default: 0},
		{Name: "upstream_cache_read_tokens", Type: field.TypeInt, Default: 0},
		{Name: "cache_billing_ratio", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,6)"}},
