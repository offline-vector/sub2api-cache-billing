...
type UsageLog struct {
	...
	// Local standard cost recalculated from provider-reported token buckets before cache reclassification
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldCacheBillingRatio, usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldUpstreamTotalCost, usagelog.FieldRateMultiplier, usagelog.FieldAccountRateMultiplier:
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.UpstreamTotalCost))
	builder.WriteString(", ")
