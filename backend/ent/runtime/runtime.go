...
func init() {
	...
	// usagelogDescUpstreamInputTokens is the schema descriptor for upstream_input_tokens field.
	usagelogDescUpstreamInputTokens := usagelogFields[20].Descriptor()
	// usagelog.DefaultUpstreamInputTokens holds the default value on creation for the upstream_input_tokens field.
	usagelog.DefaultUpstreamInputTokens = usagelogDescUpstreamInputTokens.Default.(int)
	// usagelogDescUpstreamCacheReadTokens is the schema descriptor for upstream_cache_read_tokens field.
	usagelogDescUpstreamCacheReadTokens := usagelogFields[21].Descriptor()
	// usagelog.DefaultUpstreamCacheReadTokens holds the default value on creation for the upstream_cache_read_tokens field.
	usagelog.DefaultUpstreamCacheReadTokens = usagelogDescUpstreamCacheReadTokens.Default.(int)
	// usagelogDescCacheBillingRatio is the schema descriptor for cache_billing_ratio field.
	usagelogDescCacheBillingRatio := usagelogFields[22].Descriptor()
	// usagelog.DefaultCacheBillingRatio holds the default value on creation for the cache_billing_ratio field.
	usagelog.DefaultCacheBillingRatio = usagelogDescCacheBillingRatio.Default.(float64)
	// usagelogDescCacheCreation5mTokens is the schema descriptor for cache_creation_5m_tokens field.
	usagelogDescCacheCreation5mTokens := usagelogFields[23].Descriptor()
	...
	usagelogDescCacheCreation1hTokens := usagelogFields[24].Descriptor()
	...
	// usagelogDescUpstreamTotalCost is the schema descriptor for upstream_total_cost field.
	usagelogDescUpstreamTotalCost := usagelogFields[31].Descriptor()
	// usagelog.DefaultUpstreamTotalCost holds the default value on creation for the upstream_total_cost field.
	usagelog.DefaultUpstreamTotalCost = usagelogDescUpstreamTotalCost.Default.(float64)
