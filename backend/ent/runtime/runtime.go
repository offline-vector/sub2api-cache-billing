...
func init() {
	...
	usagelogDescUpstreamInputTokens := usagelogFields[19].Descriptor()
	...
	usagelogDescUpstreamCacheReadTokens := usagelogFields[20].Descriptor()
	...
	usagelogDescCacheBillingRatio := usagelogFields[21].Descriptor()
	...
	usagelogDescUpstreamTotalCost := usagelogFields[30].Descriptor()
